//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> 05_ESP32_UDP_ESP32B_or_Slave_B
//----------------------------------------Including Libraries.
#include "WiFi.h"
#include "AsyncUDP.h"
//----------------------------------------
      ...
      udp.onPacket([](AsyncUDPPacket packet) {
        ...
        if (myID == "ESP32B") {
          ...
          if (cmd == "LED_1_ON") {
            ...
            send_Message(arr_destination_IP_Address, udpPort, "ESP32B,LED_1_ON");
          } else if (cmd == "LED_1_OFF") {
            digitalWrite(LED_1, LOW);
  
            send_Message(arr_destination_IP_Address, udpPort, "ESP32B,LED_1_OFF");
          } else if (cmd == "LED_2_ON") {
            digitalWrite(LED_2, HIGH);
  
            send_Message(arr_destination_IP_Address, udpPort, "ESP32B,LED_2_ON");
          } else if (cmd == "LED_2_OFF") {
            digitalWrite(LED_2, LOW);
  
            send_Message(arr_destination_IP_Address, udpPort, "ESP32B,LED_2_OFF");
          } else if (cmd == "GSAL") {
